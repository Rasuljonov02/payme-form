...
const register1: HTMLParagraphElement = document.querySelector(".register1")!;
const forget1: HTMLParagraphElement = document.querySelector(".forget1")!;

let malumotlar1: { name: string; lastname: string; tel: string; email: string; password: string; takrorparol: string }[] = [];
